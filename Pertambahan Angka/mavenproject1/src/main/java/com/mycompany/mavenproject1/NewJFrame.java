...
public class NewJFrame extends javax.swing.JFrame {
   ...
   hitung('/');
    ...
    // Mendapatkan nilai dari TextField pertama dan kedua
    String input1 = textField1.getText();
    String input2 = textField2.getText();

    // Memeriksa apakah kedua input adalah angka yang valid
    if (isAngkaValid(input1) && isAngkaValid(input2)) {
        double angka1 = Double.parseDouble(input1);
        double angka2 = Double.parseDouble(input2);

        // Melakukan operasi berdasarkan operator yang diterima
        double hasil = 0.0;
        if (operator == '+') {
            hasil = angka1 + angka2;
        } else if (operator == '-') {
...
private boolean isAngkaValid(String input) {
    ...
    private void button6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button6ActionPerformed
     // Mengosongkan isi TextField
    textField1.setText("");
    textField2.setText("");
    textField3.setText(""); // Jika Anda ingin mengosongkan hasil juga

    // Mengarahkan fokus kembali ke textField1
